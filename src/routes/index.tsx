    ...
    <div className="relative min-h-screen overflow-hidden bg-background text-navy">
          ...
          <div className="lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col items-start gap-4 sm:flex-row sm:items-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full border border-navy/10 bg-background px-5 py-3 text-sm font-medium text-navy transition hover:bg-navy/5 sm:ml-2"
              >
                Abrir aplicação
              </a>
      ...
      <footer className="border-t border-navy/10">
        <Section className="flex flex-col items-start justify-between gap-6 py-10 sm:flex-row sm:items-center">
          ...
          <div className="flex flex-col items-start gap-3 text-xs text-navy/55 sm:items-end">
